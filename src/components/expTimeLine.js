  ...
  const timelineList = [
    {
      ...
      subtitle: "QuantDart",
      desc: "Revamp the whole app and provide a better UI and UX to reach 1000+ daily users. Also, implement the security feature which includes 2FA and biometric security checking. Full set KYC flow is included.",
    },
    {
